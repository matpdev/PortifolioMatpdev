...
// node_modules/ngx-splide/fesm2022/ngx-splide.mjs
var _c0 = ["slideContent"];
var _c1 = ["*"];
...
var _c2 = ["splideElement"];
function NgxSplideComponent_div_4_1_ng_template_0_Template(rf, ctx) {
}
function NgxSplideComponent_div_4_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, NgxSplideComponent_div_4_1_ng_template_0_Template, 0, 0, "ng-template", 7);
  }
  if (rf & 2) {
    const slide_r1 = ɵɵnextContext().$implicit;
    ɵɵproperty("ngTemplateOutlet", slide_r1.slideContent);
  }
}
function NgxSplideComponent_div_4_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementStart(0, "div", 5);
    ɵɵtemplate(1, NgxSplideComponent_div_4_1_Template, 1, 1, null, 6);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const slide_r1 = ctx.$implicit;
    ɵɵadvance();
    ɵɵproperty("ngIf", slide_r1.slideContent);
  }
}
var _NgxSplideSlideComponent = class _NgxSplideSlideComponent {
};
_NgxSplideSlideComponent.ɵfac = function NgxSplideSlideComponent_Factory(t) {
  return new (t || _NgxSplideSlideComponent)();
};
_NgxSplideSlideComponent.ɵcmp = ɵɵdefineComponent({
  type: _NgxSplideSlideComponent,
  selectors: [["splide-slide"]],
  viewQuery: function NgxSplideSlideComponent_Query(rf, ctx) {
    if (rf & 1) {
      ɵɵviewQuery(_c0, 5);
    }
    if (rf & 2) {
      let _t;
      ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx.slideContent = _t.first);
    }
  },
  ...
  vars: 0,
  consts: [["slideContent", ""]],
  template: function NgxSplideSlideComponent_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵprojectionDef();
      ɵɵtemplate(0, NgxSplideSlideComponent_ng_template_0_Template, 1, 0, "ng-template", null, 0, ɵɵtemplateRefExtractor);
    }
  },
  encapsulation: 2
});
var NgxSplideSlideComponent = _NgxSplideSlideComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(NgxSplideSlideComponent, [{
    type: Component,
    args: [{
...
var _NgxSplideComponent = class _NgxSplideComponent {
  ...
  ngAfterViewInit() {
    ...
    const slidesSubscription = this.slides.changes.subscribe((list) => {
...
_NgxSplideComponent.ɵfac = function NgxSplideComponent_Factory(t) {
  return new (t || _NgxSplideComponent)(ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(PLATFORM_ID));
};
_NgxSplideComponent.ɵcmp = ɵɵdefineComponent({
  type: _NgxSplideComponent,
  selectors: [["splide"]],
  contentQueries: function NgxSplideComponent_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
      ɵɵcontentQuery(dirIndex, NgxSplideSlideComponent, 4);
    }
    if (rf & 2) {
      let _t;
  ...
  viewQuery: function NgxSplideComponent_Query(rf, ctx) {
    ...
    if (rf & 2) {
      let _t;
      ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx.splideElement = _t.first);
    }
  },
  inputs: {
  ...
  decls: 5,
  vars: 2,
  consts: [["splideElement", ""], [1, "splide", 3, "ngClass"], [1, "splide__track"], [1, "splide__list"], ["class", "splide__slide", 4, "ngFor", "ngForOf"], [1, "splide__slide"], [4, "ngIf"], [3, "ngTemplateOutlet"]],
  template: function NgxSplideComponent_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵelementStart(0, "div", 1, 0)(2, "div", 2)(3, "div", 3);
      ɵɵtemplate(4, NgxSplideComponent_div_4_Template, 2, 1, "div", 4);
      ɵɵelementEnd()()();
    }
    if (rf & 2) {
...
var NgxSplideComponent = _NgxSplideComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(NgxSplideComponent, [{
    type: Component,
    args: [{
      selector: "splide",
      changeDetection: ChangeDetectionStrategy.OnPush,
      template: '<div #splideElement class="splide" [ngClass]="containerClass">\r\n    <div class="splide__track">\r\n        <div class="splide__list">\r\n            <div class="splide__slide" *ngFor="let slide of slides;">\r\n                <ng-template *ngIf="slide.slideContent" [ngTemplateOutlet]="slide.slideContent"></ng-template>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</div>\r\n'
    }]
  }], () => [{
...
var _NgxSplideModule = class _NgxSplideModule {
};
_NgxSplideModule.ɵfac = function NgxSplideModule_Factory(t) {
  return new (t || _NgxSplideModule)();
};
_NgxSplideModule.ɵmod = ɵɵdefineNgModule({
  type: _NgxSplideModule,
  declarations: [NgxSplideComponent, NgxSplideSlideComponent],
  imports: [CommonModule],
  exports: [NgxSplideComponent, NgxSplideSlideComponent]
});
_NgxSplideModule.ɵinj = ɵɵdefineInjector({
  imports: [CommonModule]
});
var NgxSplideModule = _NgxSplideModule;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(NgxSplideModule, [{
    type: NgModule,
    args: [{
      declarations: [NgxSplideComponent, NgxSplideSlideComponent],
      imports: [CommonModule],
